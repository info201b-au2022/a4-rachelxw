...
### Summary: What can be hypothesized from the visualization?
...
### Summary: What does the color code tells us?
There are several states fill with grey color which indicates they are out of available data. In the map, states fill with light pink means the multiplicity ratio between the proportion of black people to be in jail and the proportion of white people is relatively small. Conversely, the states fill with bright red indicate the ratio is large, there is severe disproportion exists.